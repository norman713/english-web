...
const VocabSetCard = ({
  ...
  return (
    <div
      className={`flex flex-col h-full p-5 rounded-xl bg-white shadow-sm hover:shadow-md transition-all border border-gray-200 hover:border-blue-300 ${className}`}
    >
