...
import { getVocabularySets } from "../../../../services/vocabularyService";
      ...
      <div className="bg-white rounded-xl shadow-sm overflow-hidden">
        ...
        <div className="p-6 bg-gradient-to-r from-blue-50 to-cyan-50 border-b">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              <h1 className="text-2xl font-bold text-gray-800">My Vocabulary Sets</h1>
              <p className="text-gray-600">Manage your vocabulary collections</p>
            </div>
          ...
          {isLoading ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="mt-1 text-gray-500">
                {searchQuery ? 'Try a different search term' : 'Create some sets to get started'}
              </p>
            </div>
          )}
        </div>
