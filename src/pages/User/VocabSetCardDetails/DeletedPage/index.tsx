...
const DeletedVocabPage: React.FC = () => {
  ...
  const handlePracticeNow = async () => {
    ...
    // 2) Sau khi lưu, điều hướng vào flashcard
  ...
  return (
    <div className="max-w-full mx-auto">
      {/* Banner ở trên cùng */}
      <div className="w-full bg-red-200 text-red-800 py-3 text-center text-[50px] font-semibold text-lg min-h-25">
        Danh sách từ vựng đã xóa
      </div>

      {/* Phần nội dung chính được làm mờ 50% */}
...
export default DeletedVocabPage;
