      ...
      <div>
        ...
        {historyData.map((test, index) => (
          <div key={index} className="border mb-6">
            <div className="bg-blue-100 px-4 py-2 font-bold text-blue-700">
              {test.title}
            </div>
            {test.attempts.map((attempt, idx) => (
              <div
                key={idx}
                className="grid grid-cols-4 items-center gap-4 px-4 py-3 border-t text-sm"
              >
                <div>
