...
import { createVocabularySet } from "../../../../services/vocabularyService";
...
const AddPage = () => {
  ...
  const [cards, setCards] = useState<VocabularyCard[]>([
    { id: uuidv4(), word: "", pronunciation: "", translation: "", example: "", imageUrl: "" },
  ]);
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await createVocabularySet(userId, {
        name: setName,
  ...
  const handleInputChange = (index: number, field: keyof VocabularyCard, value: string) => {
  ...
  return (
    <div className="container mx-auto p-4 max-w-6xl">
      <div className="bg-white rounded-lg shadow p-6">
        ...
        {/* Tên bộ từ */}
        <div className="mb-8">
          <label className="block text-lg font-medium text-gray-700 mb-2">Tên bộ từ *</label>
          <input
            type="text"
        ...
        <div className="mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {cards.map((card, index) => (
              <div key={card.id} className="border border-gray-200 rounded-xl shadow-sm overflow-hidden bg-white hover:shadow-md transition-shadow">
                {/* Header */}
